...
ditf = 0;% @(E) 1.*(dite.*exp(-E/E0)+dite*exp(-(Eg-E)/E0));
...
for Vg = V_gs  
    ...
    for i = 1:NRmax
        ...
        E2 = Eg/2;
        rho_dit =0; %q/dx*integral(ditf , E1, E2);
        rho_dit_dpsi = 0; %q/dx * integral(ditf , E1 + q*dit_dpsi,E2);
        delrho_dit = 0; %1/dit_dpsi * (rho_dit_dpsi - rho_dit);
